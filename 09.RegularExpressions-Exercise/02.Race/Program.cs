...
namespace _02.Race
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Participant> topThreeParticipants = 
                participants
                .OrderByDescending(p => p.Distance)
                .Take(3)
                .ToList();

            Console.WriteLine($"1st place: {topThreeParticipants[0].Name}");
            Console.WriteLine($"2nd place: {topThreeParticipants[1].Name}");
            Console.WriteLine($"3rd place: {topThreeParticipants[2].Name}");
        }
    }
}